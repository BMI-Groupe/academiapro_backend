...
return [
    ...
    'title' => 'AcademiaPro API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API complète pour la gestion scolaire - Élèves, Notes, Emplois du temps, Paiements et plus.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Vous pouvez obtenir votre token en vous connectant via l\'endpoint <code>/api/v1.0.0/login</code>. Le token doit être envoyé dans le header Authorization avec le préfixe Bearer.',
    ],
